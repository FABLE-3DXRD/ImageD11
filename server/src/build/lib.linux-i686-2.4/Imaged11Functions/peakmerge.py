...
#         print line[0:5]
    ...
    def harvestpeaks(self, min=None, max=None, omlim=None, thresholds=None):
        """
        ...
        if min is None:
            ...
            numinrange = lambda x : x > min and x < max
        if omlim is None:
