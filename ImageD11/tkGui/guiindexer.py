...
class run_idx:
    ...
    def update(self):
        self.label.configure(
            text="Tested %8d of %8d\nFound so far %8d"
            % (self.idxer.tried, self.idxer.npairs, len(self.idxer.ubis))
        )
...
class guiindexer:
    ...
    def loadgv(self):
        ...
        filename = self.parent.opener.show(
            ...
            filetypes=[("Gvector files", "*.gve"), ("Gvector files", "*.gv")],
        )
    ...
    def editparameters(self):
        ...
        self.parent.guicommander.execute(
            "indexer", "parameterobj.set_parameters", d.result
        )
