...
from ImageD11.sinograms.lima_segmenter_utils import frmtosparse, clean_utils
try:
...
def clean(nnz, row, col, val):
    return clean_utils(nnz, row, col, val, OPTIONS.howmany, OPTIONS.thresholds, OPTIONS.mask.shape, OPTIONS.pixels_in_spot)
