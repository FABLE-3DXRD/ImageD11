...
if 0:
    ...
    ds = ImageD11.sinograms.dataset.load(
        "/data/visitor/blc14570/id11/20230425/PROCESSED_DATA/ds_Martensite500C_DTz50.h5"
    )
    ds.omega.shape, len(ds.sparsefiles)
    chosen = ds.omega.shape[0] // 2 + 1
    sps = ImageD11.sparseframe.SparseScan(
        os.path.join(ds.analysispath, ds.sparsefiles[chosen]), ds.limapath
    )
    pars = ImageD11.parameters.read_par_file(
        "/data/visitor/blc14570/id11/20230425/PROCESSED_DATA/FeBCC.par"
    ).parameters
