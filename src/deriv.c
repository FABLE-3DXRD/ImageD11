...
int g_to_k( double h[4],
    ...
    // return np.arctan2( a*d - b*c, a*c + b*d) 
    omega_calc[0] = DEG*atan2( kao[1]*gao[2] - kao[2]*gao[1], kao[1]*gao[1] - kao[2]*gao[2] );
    return 0;
}
...
int main(){
    ...
    pre[0] =1.; pre[4] =1.; pre[8] =1.;
    axis[0]=0.; axis[1]=0.; axis[2]=1.;
    beam[0]=1.; beam[1]=0.; beam[2]=0.;
